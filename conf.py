...
_C.CKPT_PATH_SEG = "checkpoint/chaos_unet2d_2ch_v2.pt"
...
_C.ACTIVE.MODE =  'PA'
_C.ACTIVE.BUDGET_SLICE =  0.5
_C.ACTIVE.BUDGET_PIXEL =  0.5
_C.ACTIVE.BUDGET_REGION =  0.5
_C.ACTIVE.Active_Round = 1
_C.ACTIVE.RADIUS_K = 1
_C.ACTIVE.NBR_RAD_SLICE = 5
_C.ACTIVE.NBR_RAD_PIXEL = 40
_C.ACTIVE.DELTA = 1.0e-2
_C.ACTIVE.RST = 0.01
_C.ACTIVE.AP = 0.9
_C.ACTIVE.M_TEACHER = 0.999
_C.ACTIVE.n_augmentations =  6
_C.ACTIVE.e_margin = 2.45
_C.ACTIVE.d_margin =  0.05
_C.ACTIVE.Equal_annotation = 1
...
_C.SOURCE.BASE_SIZE = 256

# Size to crop the image to
_C.SOURCE.CROP_SIZE = [256,256]
...
_C.DATASET.SOURCE_NAME = "CHAOS"
_C.DATASET.SOURCE_PATH = "/home/eegrad/mdislam/Dataset/Processed/CHAOS/MRI/T2SPIR"
_C.DATASET.TARGET_NAME = "DUKE"
_C.DATASET.TARGET_PATH = "/home/eegrad/mdislam/Dataset/Processed/DUKE/MRI/"
_C.DATASET.TARGET_LABEL = 1
_C.DATASET.SPLIT = "only_test_all"
_C.DATASET.PRETRAINED_PATH = "checkpoint/chaos_unet2d_2ch_v2.pt"
